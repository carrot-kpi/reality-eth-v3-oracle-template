...
contract FinalizeTest is BaseTestSetup {
    function testRealityQuestionNotFinalized() external {
        ...
        vm.mockCall(REALITY_V3_ADDRESS, abi.encodeWithSignature("resultForOnceSettled(bytes32)"), abi.encode(""));
    ...
    function testSuccess() external {
        ...
        bytes memory realityV3OracleInitializationData =
            abi.encode(REALITY_V3_ADDRESS, 1, "Test?", 60, block.timestamp + 60, 0);
